...
function buildWorksheetHtml(options: { title: string; grade: string; size: WorksheetSize; questions: PrintableQuestion[]; includeAnswers: boolean; qr: string; code: string; }) {
  ...
  .shape-row{max-width:100%;flex-wrap:wrap;row-gap:3mm}.shape-row>svg{flex:0 0 22mm;width:22mm;height:18mm}.shape-row>div{flex:0 1 27mm}.objects{max-width:100%;overflow-wrap:anywhere;word-break:break-all;white-space:normal;line-height:1.35}.two-groups{max-width:100%;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr)}.two-groups>div{min-width:0;overflow-wrap:anywhere;word-break:break-all}.visual>*{max-width:100%}
  ...
  @media(max-width:800px){.sheet{width:100%;margin:0;padding:18px}.student{grid-template-columns:1fr}.answers{grid-template-columns:1fr}.toolbar{position:fixed;right:0;bottom:0;left:0;top:auto}.sheet{padding-bottom:82px}.shape-row{gap:2mm}.shape-row>svg{flex-basis:18mm;width:18mm;height:15mm}.shape-row>div{flex-basis:21mm}.objects{font-size:20px}.two-groups{gap:3mm;font-size:18px}}
