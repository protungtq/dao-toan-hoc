...
export const grade2PracticeModules: Grade2Module[] = [
  {
    ...
    semester: 1, textbookLessons: [1, 2, 3, 4, 5, 6], icon: '🔢', color: 'from-cyan-400 to-sky-500', backgroundColor: 'bg-cyan-50', developmentStatus: 'building',
    skills: [
      { id: 'review-numbers-to-100', title: 'Số đến 100', description: 'Đọc, viết, so sánh và sắp xếp số.', icon: '💯', questionTypes: ['read-number', 'compare-number', 'number-sequence'], defaultWeight: 30 },
      { id: 'number-line-neighbors', title: 'Tia số và số liền kề', description: 'Tìm số liền trước, liền sau trên tia số.', icon: '➡️', questionTypes: ['number-line', 'previous-next-number'], defaultWeight: 25 },
      ...
      { id: 'more-less-difference', title: 'Hơn, kém bao nhiêu', description: 'So sánh và tìm phần hơn hoặc kém.', icon: '⚖️', questionTypes: ['how-many-more', 'how-many-less'], defaultWeight: 25 },
    ],
  },
  {
    ...
    semester: 1, textbookLessons: [7, 8, 9, 10, 11, 12, 13, 14], icon: '➕', color: 'from-violet-400 to-indigo-500', backgroundColor: 'bg-violet-50', developmentStatus: 'building',
    skills: [
      { id: 'addition-over-10-to-20', title: 'Cộng qua 10', description: 'Tính tổng bằng cách làm tròn 10.', icon: '➕', questionTypes: ['addition-over-10', 'addition-table'], defaultWeight: 35 },
      { id: 'subtraction-over-10-to-20', title: 'Trừ qua 10', description: 'Thực hiện phép trừ qua 10.', icon: '➖', questionTypes: ['subtraction-over-10', 'subtraction-table'], defaultWeight: 35 },
      { id: 'word-problems-to-20', title: 'Bài toán thêm – bớt', description: 'Giải tình huống thêm hoặc bớt một số đơn vị.', icon: '📖', questionTypes: ['add-word-problem', 'subtract-word-problem'], defaultWeight: 30 },
    ],
  },
  {
    ...
    semester: 1, textbookLessons: [15, 16, 17, 18], icon: '⚖️', color: 'from-emerald-400 to-teal-500', backgroundColor: 'bg-emerald-50', developmentStatus: 'building',
    skills: [
      { id: 'kilogram', title: 'Ki-lô-gam', description: 'Nhận biết và sử dụng đơn vị ki-lô-gam.', icon: '⚖️', questionTypes: ['read-scale', 'choose-kilogram'], defaultWeight: 40 },
      { id: 'liter', title: 'Lít', description: 'Nhận biết và sử dụng đơn vị lít.', icon: '🫗', questionTypes: ['compare-capacity', 'choose-liter'], defaultWeight: 35 },
      { id: 'mass-capacity-problems', title: 'Bài toán đo lường', description: 'Giải bài toán với ki-lô-gam và lít.', icon: '📖', questionTypes: ['kilogram-problem', 'liter-problem'], defaultWeight: 25 },
    ],
  },
  {
    ...
    semester: 1, textbookLessons: [19, 20, 21, 22, 23, 24], icon: '🧮', color: 'from-blue-500 to-indigo-600', backgroundColor: 'bg-blue-50', developmentStatus: 'building',
    skills: [
  ...
  },
  {
    ...
    semester: 1, textbookLessons: [25, 26, 27, 28], icon: '📐', color: 'from-orange-400 to-amber-500', backgroundColor: 'bg-orange-50', developmentStatus: 'building',
    skills: [
